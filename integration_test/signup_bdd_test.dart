...
void main() {
  ...
  group('User Signup Feature', () {
    ...
    Future<void> whenIEnterAsEmail(WidgetTester tester, String email) async {
      await tester.enterText(find.byKey(signupEmailFieldKey), email);
      await tester.pump();
    }

    Future<void> whenIEnterAsName(WidgetTester tester, String name) async {
      await tester.enterText(find.byKey(signupNameFieldKey), name);
      await tester.pump();
    }

    Future<void> whenIEnterAsPassword(WidgetTester tester, String password) async {
      await tester.enterText(find.byKey(signupPasswordFieldKey), password);
      await tester.pump();
    }
